...
(function ($) {
  ...
  $.extend(true, window, {
    "Slick": {
      "Editors": {
        ...
        "numerical" : Numerical,
        "PickListSelectEditor" : PickListSelectEditor
      }
    }
  });

  function PickListSelectEditor(args) {
	    var $select;
	    var defaultValue;
	    var scope = this;
  ...
  function DateEditor(args) {
    ...
    //args.container.addClass('invalid');
    this.init = function () {
      $input = $("<INPUT type=text class='editor-text' />");
      $input.appendTo(args.container);
      $input.focus().select();
      $input.datepicker({
        ...
        buttonImage: "StaticResources/WDCT_SlickGrid/images/calendar.gif",
        beforeShow: function () {
          calendarOpen = true
        },
        onClose: function () {
